...
export const PROMPTS: Prompt[] = [
  ...
  // Recruiter screen — the first call, usually with a recruiter (not the hiring manager): a quick
  // background read, motivation, and logistics (comp, timeline, authorization) plus a high-level fit
  // check. Answers are concise and forward-looking — this round screens OUT more than it screens in.
  {
    id: 'rec-quick-intro',
    category: 'Recruiter screen',
    label: 'Quick background overview',
    text: 'Give me a quick overview of your background and what you’re working on currently.',
    assesses: 'Whether you can summarize yourself crisply and point it at this role — in ~90 seconds.',
    tip: 'A tight arc: current role + scope → 1–2 highlights relevant to this job → what you want next. Keep it to ~90 seconds.',
    trap: 'A long, chronological life story — recruiters screen fast and will tune out.',
    avoid: 'Deep technical detail, every past job, or personal history that doesn’t point at the role.',
  },
  {
    id: 'rec-why-interested',
    category: 'Recruiter screen',
    label: 'Why this role / company',
    text: 'What caught your interest about this role and company?',
    assesses: 'Genuine, specific interest — not a mass-apply.',
    tip: 'Name 1–2 concrete things about the product/mission/problem and tie them to what you want next. Show you actually read about them.',
    trap: 'Generic reasons that fit any company (“growth, great team”).',
    avoid: 'Making it only about comp/title, or admitting you don’t know what they do.',
  },
  {
    id: 'rec-why-looking',
    category: 'Recruiter screen',
    label: 'Why you’re exploring now',
    text: 'Why are you exploring new opportunities right now?',
    assesses: 'Maturity, and that your reasons are forward-looking rather than red flags.',
    tip: 'Frame it toward what you’re moving to (scope, problem space, growth); keep it short and positive.',
    trap: 'Badmouthing your current employer or manager.',
    avoid: 'Bitterness, drama, or a vague “just seeing what’s out there.”',
  },
  {
    id: 'rec-comp',
    category: 'Recruiter screen',
    label: 'Compensation expectations',
    text: 'What are your compensation expectations for your next role?',
    assesses: 'Whether your expectations are in range, and that you handle the topic with composure.',
    tip: 'Give a researched range (or ask for theirs), anchor on total comp, and stay flexible on the right overall fit — don’t lowball yourself.',
    trap: 'Naming a single hard number too early, or sounding rattled by the question.',
    avoid: 'Disclosing your exact current salary if you’d rather not; over-negotiating before there’s an offer.',
  },
  {
    id: 'rec-timeline',
    category: 'Recruiter screen',
    label: 'Timeline & other processes',
    text: 'What’s your timeline, and are you interviewing elsewhere?',
    assesses: 'Your urgency and market, and how to sequence their process.',
    tip: 'Be honest and concise: when you could start, and that you have other conversations (signals demand) — without making it a threat.',
    trap: 'Either fake-urgency pressure tactics or sounding like you have no momentum.',
    avoid: 'Naming specific competing companies or exact offer numbers unprompted.',
  },
  {
    id: 'rec-logistics',
    category: 'Recruiter screen',
    label: 'Location, authorization & logistics',
    text: 'Where are you based, what are your expectations on location/remote, and are you authorized to work here?',
    assesses: 'Hard constraints that could disqualify before anyone spends more time.',
    tip: 'Answer the logistics plainly and up front (location/remote/onsite, work authorization, relocation). Clarity here builds trust.',
    trap: 'Being evasive about a constraint that then surfaces painfully later.',
    avoid: 'Over-explaining — just state the facts and where you’re flexible.',
  },
  {
    id: 'rec-role-fit',
    category: 'Recruiter screen',
    label: 'Your read on the role',
    text: 'What’s your understanding of this role, and why do you think you’d be a fit?',
    assesses: 'That you understand the job and can connect your experience to it quickly.',
    tip: 'Restate the role in a sentence, then map 2–3 concrete experiences of yours to its core needs.',
    trap: 'A mismatched read of the role, or generic “I’m a hard worker” fit claims.',
    avoid: 'Reciting the JD back verbatim; claiming fit with no evidence.',
  },
  {
    id: 'rec-questions',
    category: 'Recruiter screen',
    label: 'Questions for the recruiter',
    text: 'What questions do you have for me about the role, team, or process?',
    assesses: 'Engagement, and that you’re evaluating them too.',
    tip: 'Ask 1–2 sharp questions about the team, the process/timeline, or what success looks like — it shows genuine interest.',
    trap: 'Having no questions, which reads as disinterest.',
    avoid: 'Leading with comp/perks, or questions already answered on their website.',
  },
